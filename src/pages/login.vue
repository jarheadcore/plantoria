            ...
            <div class="relative z-10 flex flex-col justify-between p-14 text-white w-full">
                ...
                <div class="max-w-lg -mt-8">
                    ...
                    <p class="text-green-50/80 text-[15px] leading-relaxed max-w-md">
                        Planen Sie Projekte, verwalten Sie Aufgaben und begleiten Sie Ihre Klasse durch alle Phasen des Schulgartens &mdash;
                    ...
                    <div class="mt-10 flex flex-col gap-4">
                        <div class="flex items-center gap-4 group">
                            <div
                                class="flex h-10 w-10 items-center justify-center rounded-xl bg-white/10 ring-1 ring-white/10 backdrop-blur-sm transition-all group-hover:bg-white/15 shrink-0"
                            >
                                <Sprout :size="18" />
                            </div>
                            <div>
            ...
            <div class="w-full max-w-[420px]">
                ...
                <div class="mb-10 text-center lg:hidden">
                    <NuxtLink to="/" class="inline-block">
                        <div
                            class="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-green-500 to-emerald-600 text-white shadow-lg shadow-green-500/25"
                        >
                ...
                <div v-if="view === 'login'">
                    ...
                    <form @submit.prevent="handleLogin" class="space-y-5">
                        <div>
                            ...
                            <UInput v-model="email" type="email" placeholder="name@schule.ch" required autofocus size="xl">
                                <template #leading>
                        ...
                        <div class="flex items-center justify-between">
                            <label class="flex items-center gap-2.5 cursor-pointer select-none group">
                                ...
                                />
                                <span
                                    class="text-sm text-gray-500 group-hover:text-gray-700 dark:group-hover:text-gray-300 transition-colors"
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-100 dark:border-gray-800">
                        <p class="text-center text-xs text-gray-300 dark:text-gray-600">
                            Demo-Zugang: <span class="font-medium text-gray-400 dark:text-gray-500">anna.mueller@schule-aarau.ch</span> /
                            <span class="font-medium text-gray-400 dark:text-gray-500">plantoria</span>
                        </p>
                    </div>
                </div>
                ...
                <div v-else-if="view === 'forgot'">
                    ...
                    <form @submit.prevent="handleResetPassword" class="space-y-5">
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">E-Mail-Adresse</label>
                            <UInput v-model="resetEmail" type="email" placeholder="name@schule.ch" required autofocus size="xl">
                                <template #leading>
                                    <Mail :size="18" class="text-gray-400" />
                                </template>
                            </UInput>
                ...
                <div v-else-if="view === 'forgot-sent'">
                    <div class="text-center">
                        <div
                            class="mx-auto mb-5 flex h-20 w-20 items-center justify-center rounded-2xl bg-gradient-to-br from-green-50 to-emerald-100 dark:from-green-900/30 dark:to-emerald-900/20 ring-1 ring-green-200/50 dark:ring-green-800/30"
                        >
                        ...
                        <p class="text-[15px] text-gray-400 mb-1">Wir haben einen Link zum Zurücksetzen an</p>
