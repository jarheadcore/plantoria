...
const templateOptions = computed(() => templatesStore.templates.map((t) => ({ label: `${t.name} (${t.lp21Coverage}% LP21)`, value: t.id })))
    ...
    <div>
        ...
        <UCard class="max-w-xl">
            ...
            <div v-if="step === 1">
                ...
                <div class="space-y-4">
                    <label
                        class="flex items-start gap-3 cursor-pointer rounded-lg border border-gray-200 p-4 hover:bg-gray-50 dark:border-gray-700 dark:hover:bg-gray-800"
                    >
                ...
                <div class="mt-6 flex justify-between">
                    ...
                    <UButton color="primary" :disabled="mode === 'template' && !selectedTemplateId" @click="goNext">
                        Weiter
            ...
            <div v-if="step === 2">
                ...
                <div class="mt-6 flex justify-between">
                    ...
                    <UButton color="primary" :disabled="!projectName" @click="createProject"> Erstellen </UButton>
                </div>
            </div>
        </UCard>
    </div>
