            ...
            <div class="flex items-center justify-between">
              <div>
                ...
                <span class="text-sm text-gray-500 ml-2">
                  Stufe: {{ cls.grade }} | {{ cls.studentCount }} Schüler
                </span>
        ...
        <div class="space-y-4">
          <div>
            <label class="block text-sm font-medium mb-1">
              Tage im Voraus anzeigen
            </label>
            <div class="flex items-center gap-3">
              <UInput
                v-model.number="holidayAdvanceDays"
                type="number"
                min="1"
                max="30"
                class="w-24"
            ...
            <p class="text-xs text-gray-400 mt-1">
              Ferienaufgaben werden den Schülern so viele Tage vor den Ferien angezeigt.
            </p>
          </div>
