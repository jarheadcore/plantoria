    ...
    <div>
        <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="flex items-center gap-3">
                ...
                <UButton variant="soft" size="sm" @click="calendarStore.goToToday()"> Heute </UButton>
            </div>
        </div>
            ...
            <div class="min-w-[600px] grid grid-cols-7 gap-2">
                ...
                >
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <UBadge v-if="day.isHoliday" color="neutral" variant="subtle" size="xs"> Ferien </UBadge>
                    </div>
                    ...
                    <div class="space-y-1">
                        ...
                        <p v-if="day.entries.length === 0 && !day.isHoliday" class="text-[10px] text-gray-300 italic">Keine Einträge</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div v-if="calendarStore.viewMode === 'month'" class="overflow-x-auto">
            <div class="min-w-[600px]">
                <div class="grid grid-cols-7 gap-px mb-1">
                    <div v-for="day in weekDays" :key="day" class="py-2 text-center text-xs font-semibold text-gray-500">
                        {{ day }}
                    </div>
                </div>

                <div
                    class="grid grid-cols-7 gap-px rounded-lg border border-gray-200 bg-gray-200 dark:border-gray-800 dark:bg-gray-800 overflow-hidden"
                >
                    <div
                        ...
                        :class="[
                            'min-h-[80px] p-1.5',
                            cell.isHoliday ? 'bg-amber-50/80 dark:bg-amber-950/20' : 'bg-white dark:bg-gray-900',
        ...
        <!-- Seasonal tips -->
        <div class="mt-6">
            <h2 class="text-lg font-semibold mb-3">Saisonale Hinweise für {{ monthNames[calendarStore.currentMonth - 1] }}</h2>
            <ul class="space-y-2">
                <li
