...
<template>
    <div v-if="template">
        <div class="mb-4">
            <NuxtLink to="/teacher/templates" class="text-sm text-gray-500 hover:text-gray-700"> ← Templates </NuxtLink>
        </div>
        ...
        <UCard class="mb-6">
            ...
            <div class="mt-4 flex items-center gap-4 text-sm text-gray-500">
                <span
                    >LP21-Abdeckung: <strong>{{ template.lp21Coverage }}%</strong></span
                >
                <span
                    >Fachbereiche: <strong>{{ template.topics.length }}</strong></span
                >
            </div>
        </UCard>
                                ...
                                >
                                    <div>
                                        ...
                                        <div class="flex gap-1 mt-1">
                                            <UBadge
                                                v-for="lp21Ref in task.lp21Refs"
                                                :key="lp21Ref"
                                                color="primary"
                                                variant="subtle"
                                                size="xs"
        ...
        <UButton color="primary" variant="soft" class="mb-6" disabled> + Fachbereich hinzufügen </UButton>
    ...
    <div v-else class="py-16 text-center text-gray-500">Template nicht gefunden.</div>
</template>
