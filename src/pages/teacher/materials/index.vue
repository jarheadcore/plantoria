                ...
                <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                    <div class="flex-1">
                        ...
                        <div class="flex flex-wrap gap-x-4 gap-y-1 text-xs text-gray-500 mb-2">
                            <span
                                >Stufe: <strong>{{ mat.gradeRange }}</strong></span
                            >
                            <span v-if="mat.phase"
                                >Phase: <strong>{{ mat.phase }}</strong></span
                            >
                            <span
                                >Format: <strong>{{ mat.formats.join(' + ') }}</strong></span
                            >
                            <span
                                >Schwierigkeit: <strong>{{ mat.difficulty }}</strong></span
                            >
                        </div>
