...
<template>
    <div>
        <!-- Welcome -->
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Willkommen, {{ teacherStore.teacher.name.split(' ')[0] }}!</h1>
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <UCard>
                ...
                <div class="space-y-4">
                    ...
                    >
                        <div class="flex items-center justify-between mb-1">
                            ...
                            <UBadge :color="project.status === 'Laufend' ? 'green' : 'neutral'" variant="subtle" size="xs">
                                {{ project.status }}
                            </UBadge>
                        </div>
                ...
                <template #footer>
                    <NuxtLink to="/teacher/projects" class="text-sm text-green-600 hover:text-green-700"> Alle Projekte &rarr; </NuxtLink>
                </template>
            </UCard>
            ...
            <UCard>
                ...
                <template #footer>
                    <NuxtLink to="/teacher/curriculum" class="text-sm text-green-600 hover:text-green-700"> LP21-Tracking &rarr; </NuxtLink>
                </template>
            </UCard>
            ...
            <UCard>
                ...
                <ul class="space-y-2">
                    <li v-for="task in upcomingTasks" :key="task.id" class="flex items-center gap-3 text-sm">
                        <input
                            type="checkbox"
                ...
                <template #footer>
                    <NuxtLink to="/teacher/tasks" class="text-sm text-green-600 hover:text-green-700"> Aufgabenpool &rarr; </NuxtLink>
                </template>
            </UCard>
            ...
            <UCard>
                ...
                <template #footer>
                    <NuxtLink to="/teacher/calendar" class="text-sm text-green-600 hover:text-green-700"> Saisonkalender &rarr; </NuxtLink>
                </template>
            </UCard>
            ...
            <UCard>
                ...
                <template #footer>
                    <NuxtLink to="/teacher/materials" class="text-sm text-green-600 hover:text-green-700"> Alle Downloads &rarr; </NuxtLink>
                </template>
            </UCard>
            ...
            <UCard>
                ...
                <ul class="space-y-2">
                    <li v-for="entry in weekEntries" :key="entry.id" class="flex items-center gap-3 text-sm">
                        <span
                            :class="[
                    ...
                    <li v-if="weekEntries.length === 0" class="text-sm text-gray-400 italic">Keine Einträge diese Woche.</li>
                </ul>
                <template #footer>
                    <NuxtLink to="/teacher/calendar" class="text-sm text-green-600 hover:text-green-700"> Zum Kalender &rarr; </NuxtLink>
                </template>
            </UCard>
        </div>
    </div>
