...
import {
  Leaf, Sprout, Sun, Droplets, TreePine, FileText, Sparkles,
  FolderKanban, Download, GraduationCap, LayoutTemplate, ClipboardList,
  Users, CalendarDays, FileDown, ChevronRight, Menu, X, CheckCircle
...
const steps = [
  { num: '01', icon: FolderKanban, title: 'Projekt wählen', text: 'Wählen Sie aus bewährten Vorlagen oder erstellen Sie eigene Projekte für Ihren Schulgarten.' },
  { num: '02', icon: Download, title: 'Material herunterladen', text: 'Arbeitsblätter, Anleitungen und Hintergrundwissen — fertig aufbereitet und sofort einsetzbar.' },
  { num: '03', icon: GraduationCap, title: 'Fortschritt tracken', text: 'LP21-Kompetenzen werden automatisch erfasst. Sie sehen jederzeit, wo Ihre Klasse steht.' },
]
...
const fachbereiche = [
  'Boden', 'Fruchtfolge', 'Gemüsearten', 'Gesundheit',
  'Flächengestaltung', 'Beetplanung', 'Ernährung', 'Ökologie',
]
    ...
    <section id="hero" class="relative pt-28 pb-20 lg:pt-36 lg:pb-28 bg-gradient-to-b from-green-50/50 via-white to-white">
      <div class="mx-auto max-w-7xl px-6 flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
        ...
        <div class="flex-1 text-center lg:text-left">
          <UBadge color="green" variant="subtle" class="mb-5">
            Für Schweizer Primarschulen
          </UBadge>
          ...
          <p class="mt-6 text-lg text-gray-500 max-w-xl mx-auto lg:mx-0 leading-relaxed">
            Plantoria verbindet den Schulgarten mit dem Lehrplan 21 und begleitet Ihre Klasse
            über 6 Jahre — von der Aussaat bis zur Ernte.
          </p>
          <div class="mt-8 flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
            ...
            <UButton color="neutral" variant="outline" size="xl" @click="scrollTo('#warum')">
              Mehr erfahren
            </UButton>
          </div>
        </div>
        ...
        <div class="flex-1 flex justify-center lg:justify-end">
          <div class="relative w-72 h-72 sm:w-80 sm:h-80 lg:w-96 lg:h-96">
            ...
            <!-- Floating icons -->
            <div class="absolute top-6 left-1/2 -translate-x-1/2 flex h-14 w-14 items-center justify-center rounded-2xl bg-amber-100 text-amber-600 shadow-lg shadow-amber-200/50 animate-bounce-slow">
              <Sun :size="28" />
            </div>
            <div class="absolute bottom-12 left-8 flex h-12 w-12 items-center justify-center rounded-xl bg-green-200 text-green-700 shadow-lg shadow-green-200/50 animate-bounce-slow-delay-1">
              <Leaf :size="24" />
            </div>
            <div class="absolute bottom-12 right-8 flex h-12 w-12 items-center justify-center rounded-xl bg-blue-100 text-blue-600 shadow-lg shadow-blue-200/50 animate-bounce-slow-delay-2">
              <Droplets :size="24" />
            </div>
            <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex h-20 w-20 items-center justify-center rounded-2xl bg-green-600 text-white shadow-xl shadow-green-600/30">
              <Sprout :size="40" />
            </div>
          </div>
        </div>
    ...
    <section class="py-20 lg:py-28">
      <div class="mx-auto max-w-7xl px-6">
        ...
        <div class="grid md:grid-cols-3 gap-8 lg:gap-12 relative">
          ...
          >
            <div class="inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-green-600 text-white shadow-lg shadow-green-600/20 mb-5 relative z-10">
    ...
    <section id="funktionen" class="py-20 lg:py-28 bg-gray-50/50">
      <div class="mx-auto max-w-7xl px-6">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            <div class="flex h-11 w-11 items-center justify-center rounded-xl bg-green-50 text-green-600 group-hover:bg-green-100 transition-colors mb-4">
        ...
        <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div class="flex-1 animate-on-scroll">
            ...
            <p class="text-gray-500 leading-relaxed mb-8">
              Plantoria ordnet jede Aktivität im Schulgarten automatisch den passenden LP21-Kompetenzen zu.
              So dokumentieren Sie Lernfortschritte mühelos.
            </p>
            <ul class="space-y-4">
              <li class="flex items-start gap-3">
                <CheckCircle :size="20" class="text-green-500 mt-0.5 shrink-0" />
                <span class="text-sm text-gray-600"><strong>4 Fachbereiche</strong> abgedeckt: NMG, Mathematik, TTG, WAH</span>
              </li>
              <li class="flex items-start gap-3">
                <CheckCircle :size="20" class="text-green-500 mt-0.5 shrink-0" />
                <span class="text-sm text-gray-600"><strong>Automatisches Tracking</strong> — keine manuelle Zuordnung nötig</span>
              </li>
              <li class="flex items-start gap-3">
                <CheckCircle :size="20" class="text-green-500 mt-0.5 shrink-0" />
                <span class="text-sm text-gray-600"><strong>6 Jahre Progression</strong> vom Kindergarten bis zur 6. Klasse</span>
              </li>
            </ul>
          </div>
          ...
          <div class="flex-1 flex justify-center animate-on-scroll">
            <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 w-full max-w-sm transform rotate-1 hover:rotate-0 transition-transform">
              ...
              <div class="space-y-4">
                <div v-for="item in lp21Progress" :key="item.label">
                  ...
                  <div class="h-2 bg-gray-100 rounded-full overflow-hidden">
                    <div class="h-full rounded-full transition-all" :class="item.color" :style="{ width: item.value + '%' }" />
                  </div>
                </div>
              </div>
            </div>
    ...
    <section class="py-20 lg:py-28">
      <div class="mx-auto max-w-7xl px-6 text-center animate-on-scroll">
        <h2 class="text-3xl sm:text-4xl font-extrabold tracking-tight mb-4">
          Bereit, den Schulgarten zu starten?
        </h2>
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div>
            ...
            <ul class="space-y-2.5 text-sm">
              ...
              <li><button class="hover:text-white transition-colors" @click="scrollTo('#zielgruppen')">Zielgruppen</button></li>
            </ul>
          </div>
