...
<template>
    <div class="flex items-center gap-3">
        ...
        <!-- Notifications -->
        <div class="relative">
            <UButton variant="ghost" color="neutral" size="sm" @click="showNotifications = !showNotifications">
                <Bell :size="20" />
                <span
            ...
            >
                <div class="flex items-center justify-between border-b border-gray-200 px-4 py-3 dark:border-gray-700">
                    ...
                    <button class="text-xs text-green-600 hover:text-green-700" @click="notifStore.markAllAsRead()">Alle gelesen</button>
                </div>
                ...
                <div class="border-t border-gray-200 px-4 py-2 dark:border-gray-700">
                    <NuxtLink to="/teacher/settings" class="text-xs text-green-600 hover:text-green-700" @click="showNotifications = false">
                        Alle anzeigen
                    </NuxtLink>
                </div>
            </div>
