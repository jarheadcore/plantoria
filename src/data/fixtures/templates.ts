...
export const fixtureTaskTemplates: TaskTemplate[] = [
    ...
    // -- Jungpflanzen anziehen (topic-tmpl-3) --
    {
        id: 'tt-6',
        templateId: 'tmpl-1',
        topicTemplateId: 'topic-tmpl-3',
        title: 'Samen vorziehen (indoor)',
    ...
    // -- Aussaeen / Auspflanzen (topic-tmpl-4) --
    {
        id: 'tt-7',
        templateId: 'tmpl-1',
        topicTemplateId: 'topic-tmpl-4',
        title: 'Säen nach Plan',
        lp21Refs: ['NMG.2.1', 'NMG.2.2'],
        materialIds: [],
        order: 1,
    },
    ...
    // -- Bewaessern (topic-tmpl-8) --
    {
        id: 'tt-12',
        templateId: 'tmpl-1',
        topicTemplateId: 'topic-tmpl-8',
        title: 'Giessplan umsetzen',
        lp21Refs: [],
        materialIds: [],
        order: 1,
    },
    ...
    // -- Vermarktung (topic-tmpl-11) --
    {
        id: 'tt-16',
        templateId: 'tmpl-1',
        topicTemplateId: 'topic-tmpl-11',
        title: 'Produkte am Harvest-Markt verkaufen',
...
export const fixtureTemplates: ProjectTemplate[] = [
    {
        ...
        name: 'Gemüsefläche',
        description:
            'Vollständiges Template für den Aufbau und die Bewirtschaftung einer Gemüsefläche im Schulgarten. Deckt alle Phasen von der Planung bis zur Vermarktung ab.',
        category: 'Gemüse',
