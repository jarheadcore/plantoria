...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getQuery as getQuery$1, readBody, getResponseStatus, getRouterParam, setHeader, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatusText } from 'file:///Users/christianhuber/webdev/plantoria/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/christianhuber/webdev/plantoria/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/christianhuber/webdev/plantoria/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file:///Users/christianhuber/webdev/plantoria/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/christianhuber/webdev/plantoria/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/christianhuber/webdev/plantoria/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/christianhuber/webdev/plantoria/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/christianhuber/webdev/plantoria/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/christianhuber/webdev/plantoria/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/christianhuber/webdev/plantoria/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file:///Users/christianhuber/webdev/plantoria/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/christianhuber/webdev/plantoria/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/christianhuber/webdev/plantoria/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/christianhuber/webdev/plantoria/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/christianhuber/webdev/plantoria/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/christianhuber/webdev/plantoria/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///Users/christianhuber/webdev/plantoria/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/christianhuber/webdev/plantoria/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/christianhuber/webdev/plantoria/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/christianhuber/webdev/plantoria/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/christianhuber/webdev/plantoria/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/christianhuber/webdev/plantoria/node_modules/errx/dist/index.js';
import { isVNode, isRef, toValue } from 'file:///Users/christianhuber/webdev/plantoria/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1, basename, isAbsolute } from 'file:///Users/christianhuber/webdev/plantoria/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/christianhuber/webdev/plantoria/node_modules/unhead/dist/server.mjs';
import { renderToString } from 'file:///Users/christianhuber/webdev/plantoria/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///Users/christianhuber/webdev/plantoria/node_modules/unhead/dist/utils.mjs';
import { getIcons } from 'file:///Users/christianhuber/webdev/plantoria/node_modules/@iconify/utils/lib/index.js';
import { collections } from 'file:///Users/christianhuber/webdev/plantoria/.nuxt/nuxt-icon-server-bundle.mjs';
import localAdapter from 'file:///Users/christianhuber/webdev/plantoria/node_modules/db0/dist/connectors/better-sqlite3.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/christianhuber/webdev/plantoria/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/christianhuber/webdev/plantoria","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/christianhuber/webdev/plantoria/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/christianhuber/webdev/plantoria/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/christianhuber/webdev/plantoria/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/christianhuber/webdev/plantoria/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/Users/christianhuber/webdev/plantoria/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  }
};
...
const _FlqvPg8_buBxPVJHDXPCX5pleAiiySkBQ9gKIMf1szY = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

const rootDir = "/Users/christianhuber/webdev/plantoria";
...
const _qq3bv6HbhC1oFf0WDEYdEdgd_LaSfpFgmLsotbypc = (nitroApp) => {
...
const _DCVcE_GbjSy7Fh4AwQc9oEyLMN1g1JSaTiUgHg7WLC0 = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const plugins = [
  _FlqvPg8_buBxPVJHDXPCX5pleAiiySkBQ9gKIMf1szY,
_qq3bv6HbhC1oFf0WDEYdEdgd_LaSfpFgmLsotbypc,
_DCVcE_GbjSy7Fh4AwQc9oEyLMN1g1JSaTiUgHg7WLC0
];
...
const _79ce_U = eventHandler((event) => {
...
const getServerEntry = () => import('file:///Users/christianhuber/webdev/plantoria/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
// @ts-expect-error file will be produced after app build
const getClientManifest = () => import('file:///Users/christianhuber/webdev/plantoria/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
// -- SSR Renderer --
...
const checksums = {
  "content": "v3.5.0--nQK4lZ8UR5wgUvAwbjraZM3pJdgPgYYrYaqXpyoYumU"
};
...
const _dzF7FR = defineCachedEventHandler(async (event) => {
...
const _q4tQIv = eventHandler(async (event) => {
  ...
  return await import('file:///Users/christianhuber/webdev/plantoria/.nuxt/content/database.compressed.mjs').then((m) => m[collection]);
});
...
const _w4U2UR = eventHandler(async (event) => {
...
const _lazy_hfsnI4 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _79ce_U, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_hfsnI4, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _dzF7FR, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/content/sql_dump.txt', handler: _q4tQIv, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/info/sql_dump.txt', handler: _q4tQIv, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/content/query', handler: _w4U2UR, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/info/query', handler: _w4U2UR, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_hfsnI4, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_hfsnI4, lazy: true, middleware: false, method: undefined }
];
